...
parser.add_argument(
    '--attack-epsilon-start',
    type=float,
    default=0.0,
    metavar='EPS_START',
    help='minimum size of adversarial perturbation for training (default 0/255)')
parser.add_argument(
    '--attack-epsilon-end',
    type=float,
    default=1/255,
    metavar='EPS',
    help='max size of adversarial perturbation to increase (max size of adversarial perturbation is attack-epsilon-start + attack-epsilon-end)')
parser.add_argument(
...
parser.set_defaults(robust=True, decay_zero=False, smoothed=True, constant_kappa = True)
