...
def train(current_model, target_model, env, args):
    ...
    for frame_idx in range(start_step, args.total_frames + 1):
        ...
        if frame_idx%100000==0:
            # if args.smoothed:
            #     attack_epsilon = attack_eps_scheduler.get_eps(0, frame_idx) + args.attack_epsilon_start/255.0
            # else:
            ...
            #     attack_epsilon = lin_coeff*args.attack_epsilon_end + args.attack_epsilon_start/255.0
